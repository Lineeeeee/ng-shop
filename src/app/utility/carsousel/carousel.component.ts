...
@Component({
    ...
    <div (mouseenter)="pause()" (mouseleave)="play()" class="carousel slide">
      <ol class="carousel-indicators" [hidden]="slides.length <= 1">
         <li *ngFor="let slidez of slides" style="margin-right: 10px;width: 12px;height: 12px;" [class.active]="slidez.active === true" (click)="select(slidez)"></li>
      </ol>
      <div class="carousel-inner" style="margin-top: 20px;"><ng-content></ng-content></div>
                  <a class="left carousel-control" style="width: 35px;height: 70px;margin-top: 165px; margin-left: 260px;" (click)="prev()" [hidden]="!slides.length">
                  <span class="glyphicon glyphicon-chevron-left"></span>
                  </a>
                  <a class="right carousel-control" style="width: 35px;height: 70px;margin-top: 165px; margin-right: 260px;" (click)="next()" [hidden]="!slides.length">
